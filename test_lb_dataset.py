...
# TODO(test_lb_dataset): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(test_lb_dataset): BibTeX citation
_CITATION = """
"""


class TestLbDataset(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for test_lb_dataset dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(test_lb_dataset): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    archive_path = dl_manager.manual_dir / 'leaderboard.zip'
    ...
    return {
        'train': self._generate_examples(
          sessions_path=extracted_path / 'X_lb.pkl'
      )
    }
